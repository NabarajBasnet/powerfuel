            ...
            <div className='w-64 h-full'>
                <div className='w-full h-full flex justify-center items-start bg-gray-800'>
                    <ScrollArea className="h-full w-full overflow-y-auto p-1">
                        ...
                        <h1 className="text-start mx-5 font-semibold text-gray-400">Generals</h1>
                        ...
                        <h1 className="text-start mx-5 font-semibold text-gray-400 mt-2">Users</h1>
                        <div className='w-full'>
                            <Accordion type="single" collapsible>
                                <AccordionItem value="item-2">
                                    <AccordionTrigger>
                        ...
                        <h1 className="text-start mx-5 font-semibold text-gray-400 mt-2">Other Apps</h1>
                        <div className='w-full'>
                            <Accordion type="single" collapsible>
                                <AccordionItem value="item-2">
                                    <AccordionTrigger>
                        ...
                        <h1 className="text-start mx-5 font-semibold text-gray-400 mt-2">Support</h1>
                        <div className='w-full'>
                            <Accordion type="single" collapsible>
                                <AccordionItem value="item-2">
                                    <AccordionTrigger>
